...
SERVICE = {
    "pyoidcOICDyn": {
        ...
        "client_id": "None",
        "client_secret": "None",
        "description": "Use discovery to login at pyoidc oc3 server with "
                       "OpenId connect.",
        "class": pyoidcOIC,
    ...
    "description": "User static settings to login at pyoidc oc3 server with "
                   "OpenId connect.",
    "class": pyoidcOIC,
    ...
    "pyoidcOAuth": {
    #{'client_secret':
    # '1156c63d5cc94f62ca0fb717ab29755b7f7664bf3c5a84c04aede560',
    # 'policy_url': '', 'redirect_uris': [('http://hashog.umdc.umu
    # .se:8666/pyoidcOAuth', None)], 'logo_url': '', 'client_id':
    # 'u1fD2wvxhw0S'}
    "opKey": "pyoidcOAuth",
